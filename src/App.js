...
function NumberGame() {
  ...
  const copiarPix = () => {
    const pixKey = "bdeeaee6-1269-4984-9227-649657648017";
        ...
        <>
          ...
          {step === 7 && (
            <div className="pix-donation-container">
              <p className="pix-donation-title">Gostou? Aceito doações pelo trabalho!</p>
              
              <div className="pix-key-wrapper">
                <span className="pix-key-text">bdeeaee6-1269-4984-9227-649657648017</span>
                <button className="pix-copy-button" onClick={copiarPix}>
                  Copiar
                </button>
              </div>
              
              <img src={qrcode} alt="QR Code Pix" className="pix-qrcode" />
              
              <button className="btn-secondary" onClick={reiniciarJogo}>
                Jogar outra vez
              </button>
            </div>
          )}
